...
import {StyleSheet, Image, View, Platform, Text,Dimensions} from "react-native";
...
export default class DrawerMenu extends Component<Props> {
  ...
  async componentWillMount() {
    ...
    } else if (this.props.navigator.state.routeName === "Record") {
      this.setState({SettingsActive: true});
    } else if (this.props.navigator.state.routeName === "Vaccine") {
